...
export default function Header() {
  return (
    ...
    // </div>
    <>
   <nav class="sticky top-0  bg-gray-800 p-5 sm:px-24 xl:px-64">
    <div class="mx-auto flex justify-between items-center">
        <a href="#"
           class="uppercase text-white text-xl xl:text-3xl font-bold whitespace-no-wrap font-Montserrat leading-normal tracking-tighter">
            <img class="h-10 mx-auto" src="https://gotechark.com/wp-content/uploads/2023/07/techark-footer-logo.svg" alt=""/></a>
